<?php $__env->startSection('footer'); ?>
    ...
    <div class="d-flex"
        ...
        <div id="_footer" class="p-2" style="flex: 30%; height: 45vh;">
            ...
            <h6> &nbsp;</h6>
            <h6><a href="">eshop@junaidjamshed.com</a></h6>
        </div>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Office work\first-projecttest\resources\views/user_components/footer.blade.php ENDPATH**/ ?>